...
export declare function lookUpIcon(name?: string, size?: number): import("./gtk-types/gtk-3.0.js").Gtk.IconInfo | null;
...
export declare function subprocess(cmd: string | string[], callback: (out: string) => void, onError?: (message?: any, ...optionalParams: any[]) => void, bind?: InstanceType<typeof Gtk.Widget>): import("./gtk-types/gio-2.0.js").Gio.Subprocess | null;
