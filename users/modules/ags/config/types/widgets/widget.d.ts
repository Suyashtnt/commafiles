...
import { BindableProps, Props } from "../service.js";
...
export type BaseProps<Self extends Gtk.Widget, Props> =
  ...
  >;
export declare function register<T extends WidgetCtor>(
  klass: T,
...
export declare class Connectable<T> extends Gtk.Widget {
  hook<Self extends Connectable<T> & T, GObject extends GObject.Object>(
    gobject: GObject | App,
  ...
  on<Self extends Connectable<T> & T>(
    signal: string,
    callback: (self: Self, ...args: any[]) => void,
  ): Self;
  poll<Self extends Connectable<T> & T>(
    timeout: number,
    callback: (self: Self) => void,
  ): Self;
}
type WidgetCtor = new (...args: any[]) => Gtk.Widget;
declare function AgsWidget<W extends WidgetCtor, Self extends InstanceType<W>>(
  Widget: W,
  typename?: string,
): {
  new (...args: any[]): {
    ...
    get_template_child(
      widget_type: GObject.GType<unknown>,
      name: string | null,
    ): GObject.Object;
    ...
    connect(
      ...
      callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void,
    ): number;
    connect(
    ...
    emit(
      sigName: "screen-changed",
      previous_screen: Gdk.Screen | null,
      ...args: any[]
    ): void;
    ...
    bind_property_full(
      ...
      target_property: string | null,
      flags: GObject.BindingFlags,
      transform_to: GObject.TClosure<any, any>,
      transform_from: GObject.TClosure<any, any>,
    ): GObject.Binding;
    force_floating(): void;
    freeze_notify(): void;
